...
if occupation_activities.empty:
    ...
    activity_ai = activity_profile.merge(
        anthropic_df,
        left_on="Element ID",
    ...
    activity_ai = activity_ai[
        activity_ai["metric_id"] == "ai_autonomy_mean"
    ]

    # get the data with the most recent date
    activity_ai = (
        activity_ai
    ...
    if activity_ai.empty:
        ...
        average_autonomy = activity_ai["value"].mean()
