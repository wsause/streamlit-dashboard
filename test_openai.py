...
openai_df = pd.read_csv("occ_level.csv")
...
# Keep full O*NET-SOC code for O*NET/OpenAI matching
cip_df["O*NET Code"] = (
...
# Create stripped SOC code for BLS matching only
...
selected_onet_code = occupation_df.loc[
    occupation_df["O*NET-SOC 2019 Title"] == selected_occupation,
    "O*NET Code"
].iloc[0]


selected_soc_code = occupation_df.loc[
    occupation_df["O*NET-SOC 2019 Title"] == selected_occupation,
    "Occupation Code"
].iloc[0]
...
# ---------------------------------------------------
# AI Exposure Metrics (OpenAI dv_rating)
# ---------------------------------------------------
...
if occupation_aiexposure.empty:
    ...
    st.subheader("AI Exposure Rating")
